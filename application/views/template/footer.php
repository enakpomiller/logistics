...
<!--Start of Tawk.to Script-->
		 ...
		 s1.async=true;
		 s1.src='https://embed.tawk.to/626d3a2ab0d10b6f3e701097/1g1tame2d';
		 s1.charset='UTF-8';
	...
	<div class="container">
		<div class="col-lg-3 col-md-3 col-sm-6">
			...
			<ul class="info-links">
				...
				<li><a href="<?=base_url('users/services')?>"><i class="fa fa-hand-o-right" aria-hidden="true"></i> Services </a></li>
...
<script src="<?=base_url()?>assets/js/bgfader.js"></script>

<script>
var myBgFader = $('.header').bgfader([
  '<?=base_url()?>assets/images/banner1-1.jpg',
  '<?=base_url()?>assets/images/banner1-2.jpg',
  '<?=base_url()?>assets/images/banner1-3.jpg',
  '<?=base_url()?>assets/images/banner1-4.jpg',
], {
  'timeout': 2000,
  'speed': 3000,
  'opacity': 0.4
